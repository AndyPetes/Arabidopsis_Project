...
with open(sys.argv[3],"r") as IN:
        for line in IN:
                if sys.argv[4] == "2":
                     ...
                     if Outgroup1 == "0,0,0,0" and Outgroup2 == "0,0,0,0" and float(Prob) >= 0.5:
                         print(Loc + "\t" + Dic_Major[Loc] + "\t" + str(Prob) + "\t" + "Ancestral" + "\t" + "No_Outgroup" + "\t" + Dic_Minor[Loc])
                     elif Outgroup1 == "0,0,0,0" and Outgroup2 == "0,0,0,0" and float(Prob) < 0.5:
                         print(Loc + "\t" + Dic_Major[Loc] + "\t" + str(Prob) + "\t" + "Derived" + "\t" + "No_Outgroup" + "\t" + Dic_Minor[Loc])
                     elif float(Prob) >= 0.5:
                         print(Loc + "\t" + Dic_Major[Loc] + "\t" + str(Prob) + "\t" + "Ancestral" + "\t" + Dic_Minor[Loc])
                     else:
                         print(Loc + "\t" + Dic_Major[Loc] + "\t" + str(Prob) + "\t" + "Derived" + "\t" + Dic_Minor[Loc])
                if sys.argv[4] == "3":
                     fields = line.strip("\n").split("\t")
                     Outgroup1 = fields[-3]
                     Outgroup2 = fields[-2]
                     ...
                     Loc = fields[0]
                     Prob = Allele_Prob[Loc]
                     if Outgroup1 == "0,0,0,0" and Outgroup2 == "0,0,0,0" and Outgroup3 == "0,0,0,0" and float(Prob) >= 0.5:
                         print(Loc + "\t" + Dic_Major[Loc] + "\t" + str(Prob) + "\t" + "Ancestral" + "\t" + "No_Outgroup" + "\t" + Dic_Minor[Loc])
                     elif Outgroup1 == "0,0,0,0" and Outgroup2 == "0,0,0,0" and Outgroup3 == "0,0,0,0" and float(Prob) < 0.5:
                         print(Loc + "\t" + Dic_Major[Loc] + "\t" + str(Prob) + "\t" + "Derived" + "\t" + "No_Outgroup" + "\t" + Dic_Minor[Loc])
                     elif float(Prob) >= 0.5:
                         print(Loc + "\t" + Dic_Major[Loc] + "\t" + str(Prob) + "\t" + "Ancestral" + "\t" + Dic_Minor[Loc])
                     else:
